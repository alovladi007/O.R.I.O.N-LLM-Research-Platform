...
class Material(Base):
    ...
    # Metadata (flexible JSON for future properties). Attribute named
    # `extra_metadata` to avoid SQLAlchemy's reserved `Base.metadata`;
    # migration 009 (Session 1.2b) renamed the DB column to match.
